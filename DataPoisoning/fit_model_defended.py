...
# Approach: Based on one of the techniques in https://arxiv.org/pdf/1607.00133.pdf
# specifically, the norm clipping at the bottom left of page 3
# https://arxiv.org/pdf/2002.11497.pdf also addresses this defense and finds that
# it works pretty well against non-state of the art attacks, but concedes that those
# attacks aren't very realistic. Therefore, hopefully this will work.
